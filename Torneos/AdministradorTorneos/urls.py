...
urlpatterns = [
    ...
    path('reset_password/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name="AdministradorTorneos/password_reset_form.html"), name="password_reset_confirm"),
